...
nnoremap("<leader>uf", function() vim.cmd.Deploy("upload") end, { silent = false }, "Upload File")
nnoremap("<leader>uF", function() vim.cmd.Deploy("upload force") end, { silent = false }, "Upload File")
nnoremap("<leader>ud", function() vim.cmd.Deploy("download") end, { silent = false }, "Download File")
nnoremap("<leader>uD", function() vim.cmd.Deploy("download force") end, { silent = false }, "Download File")
nnoremap("<leader>us", function() vim.cmd.Deploy("remotesync") end, { silent = false }, "Sync Remote")
nnoremap("<leader>uS", function() vim.cmd.Deploy("remotesync force") end, { silent = false }, "Sync Remote")
nnoremap("<leader>ur", function() vim.cmd.Deploy("exec") end, { silent = false }, "Sync Remote")
nnoremap("<leader>uR", function() vim.cmd.Deploy("exec force") end, { silent = false }, "Sync Remote")
nnoremap("<leader>uc", function() vim.cmd.Deploy("connect") end, { silent = false }, "Sync Remote")
nnoremap("<leader>uC", function() vim.cmd.Deploy("connect force") end, { silent = false }, "Sync Remote")
...
-- Todo
nnoremap("<leader>t", function() vim.cmd.TodoTelescope() end, {}, "Todo List")
...
function LspKeyMap()
    ...
    nnoremap("<leader>k", "<cmd>Lspsaga peek_definition<CR>")
